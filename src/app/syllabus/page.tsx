    ...
    <Box pt='40px'>
      <Container maxW={1400} pb='40px'>
        <Center flexDir='column'>
          <Heading alignContent={{ base: 'left' }} size='2xl' >Course Syllabus</Heading>
          <Text textAlign='center' px={{ lg: '150px', base: '20px' }} pt='20px'>The first three quarters are shared by all specialties and are dedicated to studying Object-Oriented Programming and cutting-edge Full-Stack Web 2.0 development. It is going to be a fifteen-month-long hybrid program that includes both onsite and online classes and is divided into five quarters of 13 weeks each</Text>
        </Center>
        <Center flexDir='column'>
          <Heading mt='30px' >Common In All</Heading>
          <Text textAlign='center' px={{ lg: '150px', base: '20px' }} pt='20px'>Every participant of the program will start by completing the following three core courses:</Text>
        </Center>
        <Center>
          <Flex gap='34px' mb='30px' pt='60px' justifyContent='center' flexDir={{ lg: 'row', base: 'column' }}>
            {core.map((elem) => (
        ...
        <Center flexDir='column'>
          ...
          <Text textAlign='center' px={{ lg: '150px', base: '20px' }} pt='20px'>After completing the first two quarters the participants will select one or more specializations consisting of two courses each:</Text>
        </Center>
      </Container>
          ...
          <Box key={elem.id}>
            <RevealWrapper origin='left' delay={200} duration={2000} distance='500px' reset={true}>
              <Center flexDir='column'>
                ...
                <Text fontWeight='medium' color='black' textAlign='center' px={{ lg: '150px', base: '20px' }} pt='20px'>{elem.text1}</Text>
              </Center>
            </RevealWrapper>
            <Center>
              <Flex gap='34px' mb='30px' pt='60px' justifyContent='center' flexDir={{ lg: 'row', base: 'column' }}>
